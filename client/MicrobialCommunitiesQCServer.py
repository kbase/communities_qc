...
from MicrobialCommunitiesQCImpl import MicrobialCommunitiesQC
impl_MicrobialCommunitiesQC = MicrobialCommunitiesQC(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_MicrobialCommunitiesQC.get_drisee_compute, name = 'MicrobialCommunitiesQC.get_drisee_compute',
                             types = [dict])
        self.rpc_service.add(impl_MicrobialCommunitiesQC.get_drisee_instance, name = 'MicrobialCommunitiesQC.get_drisee_instance',
                             types = [dict])
        self.rpc_service.add(impl_MicrobialCommunitiesQC.get_histogram_compute, name = 'MicrobialCommunitiesQC.get_histogram_compute',
                             types = [dict])
        self.rpc_service.add(impl_MicrobialCommunitiesQC.get_histogram_instance, name = 'MicrobialCommunitiesQC.get_histogram_instance',
                             types = [dict])
        self.rpc_service.add(impl_MicrobialCommunitiesQC.get_kmer_compute, name = 'MicrobialCommunitiesQC.get_kmer_compute',
                             types = [dict])
        self.rpc_service.add(impl_MicrobialCommunitiesQC.get_kmer_instance, name = 'MicrobialCommunitiesQC.get_kmer_instance',
                             types = [dict])
        ...
        if environ['REQUEST_METHOD'] == 'OPTIONS': # we basically do nothing and just return headers
            ...
            try:
                ...
                try:
                    ...
                    impl_MicrobialCommunitiesQC.ctx = ctx
