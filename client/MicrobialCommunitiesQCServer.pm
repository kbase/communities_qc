package MicrobialCommunitiesQCServer;
...
our %return_counts = (
        'get_drisee_compute' => 1,
        'get_drisee_instance' => 1,
        'get_histogram_compute' => 1,
        'get_histogram_instance' => 1,
        'get_kmer_compute' => 1,
        'get_kmer_instance' => 1,
        'version' => 1,
);
...
sub call_method {
    ...
    my $ctx = MicrobialCommunitiesQCServerContext->new(client_ip => $self->_plack_req->address);
    
    my $args = $data->{arguments};

    # Service MicrobialCommunitiesQC does not require authentication.
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service MicrobialCommunitiesQC.");
    }
...
package MicrobialCommunitiesQCServerContext;

use strict;

=head1 NAME

MicrobialCommunitiesQCServerContext
