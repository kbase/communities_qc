...
class MicrobialCommunitiesQC:
    ...
    def get_drisee_compute(self, GetDriseeComputeParams):
        ...
        arg_hash = { 'method': 'MicrobialCommunitiesQC.get_drisee_compute',
                     'params': [GetDriseeComputeParams],
                     'version': '1.1',
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_drisee_instance(self, GetDriseeInstanceParams):
        ...
        arg_hash = { 'method': 'MicrobialCommunitiesQC.get_drisee_instance',
                     'params': [GetDriseeInstanceParams],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_histogram_compute(self, GetHistogramComputeParams):
        ...
        arg_hash = { 'method': 'MicrobialCommunitiesQC.get_histogram_compute',
                     'params': [GetHistogramComputeParams],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_histogram_instance(self, GetHistogramInstanceParams):
        ...
        arg_hash = { 'method': 'MicrobialCommunitiesQC.get_histogram_instance',
                     'params': [GetHistogramInstanceParams],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_kmer_compute(self, GetKmerComputeParams):
        ...
        arg_hash = { 'method': 'MicrobialCommunitiesQC.get_kmer_compute',
                     'params': [GetKmerComputeParams],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
...
#            ret = urllib2.urlopen(self.url, body, timeout = self.timeout)
    ...
    def get_kmer_instance(self, GetKmerInstanceParams):
        ...
        arg_hash = { 'method': 'MicrobialCommunitiesQC.get_kmer_instance',
                     'params': [GetKmerInstanceParams],
                     'version': '1.1',
                     'id': str(random.random())[2:]
                     }
