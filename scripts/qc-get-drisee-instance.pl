...
sub usage {
  print "qc-get-drisee-instance.pl >>> retrieve a drisee profile for a metagenome from the communities API\n";
  print "qc-get-drisee-instance.pl -id <id of the metagenome>\n"; 
}

sub help {
  my $text = qq~NAME

qc-get-drisee-instance -- retrieve a drisee profile for a metagenome from the communities API
...
qc-get-drisee-instance [-h] -id metagenome_id

DESCRIPTION

Retrieve a drisee profile for a metagenome from the communities API

PARAMETERS

-id metagenome_id

ID of the metagenome to retrieve the drisee profile for
...
qc-get-drisee-instance -id "kb|mg.1"
...
my $HOST      = 'http://kbase.us/services/communities_qc/drisee/';
my $id        = '';
my $user      = '';
my $pass      = '';
my $token     = '';
