...
sub usage {
  print "qc-get-drisee-compute.pl >>> request a drisee profile computation for a metagenome from the communities API\n";
  print "qc-get-drisee-compute.pl -id <id of the metagenome>\n"; 
}

sub help {
  my $text = qq~NAME

qc-get-drisee-compute -- request a drisee profile computation for a metagenome from the communities API
...
qc-get-drisee-compute [-h] -id metagenome_id

DESCRIPTION

Request a drisee profile computation for a metagenome from the communities API
...
qc-get-drisee-compute -id "kb|mg.1"
